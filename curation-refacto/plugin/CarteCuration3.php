    ...
    public function bnpp_acf_init() {
        if (function_exists('acf_register_block')) {
            acf_register_block(array(
                ...
                'render_template' => get_template_directory() . '/template-parts/block/carte-curation-3.php',
                'category'        => 'BNPP',
                'icon'            => 'admin-users',
                'keywords'        => array('curation', 'carte', 'citation', 'personne', 'card'),
                'enqueue_assets'  => function() {
                    wp_enqueue_style('carte-curation-3-css', BNPP_URL . '/assets/css/carte-curation-3.css');
                },
                'supports' => array(
                    'align' => false,
                ),
