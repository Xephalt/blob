    ...
    public function bnpp_acf_init() {
        if (function_exists('acf_register_block')) {
            acf_register_block(array(
                ...
                'render_template' => get_template_directory() . '/template-parts/block/carte-curation-1.php',
                'category'        => 'BNPP',
                'icon'            => 'format-image',
                'keywords'        => array('curation', 'carte', 'image', 'card'),
                'enqueue_assets'  => function() {
                    wp_enqueue_style('carte-curation-1-css', BNPP_URL . '/assets/css/carte-curation-1.css');
                },
                'supports' => array(
                    'align' => false,
                ),
