...
.cc2-card.is-clickable { cursor: pointer; }
.cc2-card.is-clickable:hover {
...
.cc2-card__link:hover { color: #1b5e20; text-decoration-thickness: 2px; }
.cc2-card__link::before {
  content: '';
...
.cc2-card__picto img { width: 100%; height: 100%; object-fit: cover; }
</style>
...
<?php echo $tag_open; ?> class="<?php echo esc_attr($card_class); ?>"<?php echo $anchor_attrs; ?>>
  ...
  <div class="cc2-card__content">
    ...
    <span class="cc2-card__link" role="text"><?php echo esc_html($cc2_link_text); ?></span>
  </div>
